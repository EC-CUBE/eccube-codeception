...
class PageManagePage extends AbstractAdminPage
{
    ...
    public function ページ編集($pageName)
    {
        ...
        $this->tester->click(['xpath' => "//*[@id='sortable_list_box__list']//div[@class='item_box tr']/div[@class='item_pattern td']/a[contains(text(),'${pageName}')]/parent::node()/parent::node()/div[@class='icon_edit td']/div/ul/li[1]/a"]);
    }
